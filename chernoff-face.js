...
function createFace(faceData, gElem, centroid) {
  var face = gElem;
  var SIZE = 20;
  ...
  var leftControl = [
    centroid[0] - SIZE * 0.25,
    centroid[1] - SIZE * 0.65,
  ];
  var leftEnd = [
    centroid[0] - SIZE * 0.1,
    centroid[1] - SIZE * 0.5,
  ...
  var mouthPath = `M${centroid[0] - SIZE * 0.3},${
    centroid[1] + SIZE * 0.3
  } Q${centroid[0]},${
    centroid[1] + SIZE * 0.3 - SIZE * 0.3 * (faceData.mouth - 2)
  } ${centroid[0] + SIZE * 0.3},${centroid[1] + SIZE * 0.3}`;
  // Face
  face
    .append("ellipse")
    .attr("cx", centroid[0])
